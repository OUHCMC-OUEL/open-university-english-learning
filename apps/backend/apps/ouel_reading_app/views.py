...
class PartViewSet(viewsets.ModelViewSet):
    ...
    def questions(self, request, pk):
        ...
        return Response(
            serializers.QuestionSerializer(questions, many=True).data,
    ...
    def random(self, request):
        ...
        return Response(
            serializers.PartSerializer(part).data, status=status.HTTP_200_OK
        )
    ...
    def type(self, request):
        try:
            ...
            return Response(
                serializers.PartSerializer(part, many=True).data,
                status=status.HTTP_200_OK,
            )
    ...
    def all(self, request):
        try:
            ...
            return Response(
                serializers.PartSerializer(parts, many=True).data,
                status=status.HTTP_200_OK,
            )
        except Exception as ex:
            return Response(
...
class PartHistoryViewSet(viewsets.ViewSet):
    ...
    def submit(self, request):
        ...
        return Response(
            serializers.PartHistorySerializer(part_history).data,
